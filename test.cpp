...
TEST(AOC, PUZZLE_SAMPLE_1) {
    ...
    EXPECT_EQ(puzzle_sample_1(get_base_file_path()), 374);
}

TEST(AOC, PUZZLE_SAMPLE_2) {
    fmt::println("{}", base_file_path);
    EXPECT_EQ(puzzle_sample_2(get_base_file_path()), 791134099634);
}

TEST(AOC, PUZZLE_1) {
    fmt::println("{}", base_file_path);
    EXPECT_EQ(puzzle_1(get_base_file_path()), 9681886);
}

TEST(AOC, PUZZLE_2) {
    EXPECT_EQ(puzzle_2(get_base_file_path()), 791134099634);
}
